...
export const POWER_PLANT_EQUIPMENT_ROOT = group('Power Plant', [
  ...
  group('70TPH BLR', [
    group('Auxiliary Equipment', [
      named('ID Fan -01', 'ID Fan -1'),
      named('ID Fan -02', 'ID Fan-2'),
      named('FD Fan', 'FD Fan-1'),
      named('SA Fan -01', 'SA Fan -1'),
      ...
      named('BFP -02', 'BFP-2'),
      named('BFP -03', 'BFP-3'),
      named('HP', 'HP Heater -1'),
      named('LP', 'HP Heater -2'),
      leaf('Transfer Pump'),
    ...
    group('Fuel Handling System', [
      named('Bagasse Elevator', 'Bagasse Elevator'),
      named('MBC', 'BC-1'),
      named('RBC', 'Slat Chain'),
    ]),
    group('Fuel Feeding System', [
