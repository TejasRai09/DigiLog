-- Hub apps + single navigation form each (Mill House / Power Plant equipment, EHS).
-- Employees see these only when mapped (mappings / mapping_forms). Dashboard uses GET /apps.
