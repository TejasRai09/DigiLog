    ...
    sections: [
      {
        ...
        children: [
          ...
          bulletBold('DigiLog/mysql/init.sql', 'Database table definitions for audit_logs, user_sessions, and user_activity_logs.'),
          ...
          bulletBold('DigiLog/backend/utils/sessionActivity.js', 'Session start/heartbeat/end and activity insert/exit helpers.'),
          bulletBold('DigiLog/backend/controllers/auditLog.controller.js', 'Change-log list API with cascading module/screen/resource filters.'),
          bulletBold('DigiLog/backend/controllers/sessionActivity.controller.js', 'Session + activity write APIs used by the SPA tracker.'),
          bulletBold('DigiLog/backend/controllers/activityAdmin.controller.js', 'Admin list APIs for activity logs, sessions, and cascade filter options.'),
          bulletBold('DigiLog/backend/routes/admin.routes.js', 'Admin routes for audit / activity / sessions / filter options.'),
          bulletBold('DigiLog/backend/routes/activity.routes.js', 'Authenticated SPA activity write routes.'),
          bulletBold('DigiLog/frontend/src/components/ActivityTracker.jsx', 'Session heartbeat + page-view / dwell tracking.'),
          bulletBold('DigiLog/frontend/src/utils/activityPath.js', 'Maps SPA routes to section / card / form labels.'),
          bulletBold('DigiLog/frontend/src/components/admin/config/AuditLogSection.jsx', 'Admin UI — Change / Activity / Session tabs with cascading filters.'),
          bulletBold('DigiLog/frontend/src/components/admin/config/adminConfigSections.js', 'Tab registration in Admin Config.'),
          bulletBold('DigiLog/docs/AUDIT_SYSTEM.md', 'Markdown technical documentation for the full audit system.'),
          ...
          // ── 15. Session Tracking ────────────────────────────
          heading('15. Session & Login Duration Tracking'),
          para('To answer questions like "how long was this user logged in?" and "who is online right now?", a dedicated session tracking table is used. Each login creates a session record; logouts, timeouts, and heartbeat misses close it.'),

          heading('15.1 Database Table — user_sessions', HeadingLevel.HEADING_2),
          ...
          bulletBold('Admin Config', 'Employees, Employee Categories, Season Mapping, BI Dashboards, Audit & Activity (Change / Activity / Session logs). Accessible from the navbar (admin only).'),
