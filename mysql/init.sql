...
-- Per-user starred Sugar / Power hierarchy folders and equipment cards
...
-- All-user Sugar / Power hierarchy card move history
...
-- Production House Equipment History (one card per extract sheet; no OEM)
